...
CREATE TABLE PRENOTAZIONES(
	...
	PRIMARY KEY(SOCIO,EVENTO,N_BIGLIETTI, DATA_ACQUISTO)
);
...
CREATE TABLE PRENOTAZIONEN(
	...
	FOREIGN KEY(NONSOCIO) REFERENCES NONSOCIO(CF),
	FOREIGN KEY(EVENTO) REFERENCES EVENTO(ID),
	PRIMARY KEY(NONSOCIO,EVENTO,N_BIGLIETTI, DATA_ACQUISTO)
);
...
CREATE TABLE PASSAGGIO(
	...
	TIPOLOGIA_PRECEDENTE CHAR(15) NOT NULL,
	SOCIO CHAR(16),
	PRIMARY KEY(TIPOLOGIA_PRECEDENTE, SOCIO),
	FOREIGN KEY(SOCIO) REFERENCES SOCIO(CF) ON UPDATE CASCADE ON DELETE CASCADE
);
