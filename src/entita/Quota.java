 ...
 * 
 * 
 * Classe che si occupa di mappare l'entit� Quota nel database
 */
public class Quota {
	private int id;
	...
	/**
	 * Costruttore, una quota � costituita da un id,
	 ...
	 * @return true se le propriet� delle Quote corrispondono, altrimenti false
	 */
